...
public class Parking {
    ...
    public static void main(String[] args) {
        ...
        now.setHours(0);
        int hoursLater = 2;
        Date futureDate = new Date(System.currentTimeMillis() + hoursLater * 60 * 60 * 1000);
        boolean isVIP = false;
        Parking parking = new Parking(now, futureDate, isVIP);
        System.out.println("Price: " + parking.getPrice());
        isVIP = true;
        parking = new Parking(now, futureDate, isVIP);
        System.out.println("VIP Price: " + parking.getPrice());
    }
}